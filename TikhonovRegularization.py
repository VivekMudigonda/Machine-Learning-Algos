...
def levenberg_marquardt_fit(file_path, num_iterations, lambda_):
    """Perform Tikhonov optimization with manual iterations."""
    # Load the CSV file
    ...
    for iteration in range(1, num_iterations + 1):
        ...
        delta_params = np.linalg.solve(JTJ_damped, JTr - lambda_*params)  # Solve for Δp
    ...
    plt.ylabel("y")
    plt.legend()
    plt.title("Tikhonov Nonlinear Least Squares Fit")
    plt.show()
